...
def setup_logging(
    ...
    *,
    ...
    resolved_level = _parse_level(level or os.environ.get("AUTH_LOG_LEVEL") or os.environ.get("LOG_LEVEL"))
    ...
    file_path = log_file or os.environ.get("AUTH_LOG_FILE")
    if file_path:
        path = Path(file_path)
